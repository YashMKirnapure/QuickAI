  ...
  return (
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <h1 className="tex-xl font-semibold">Resume Review</h1>
        </div>
        ...
        <button className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#00DA83] to-[#009BB3] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer">
          {
            loading ? (<span className='w-4 h-4 my-1 border-2 border-t-transparent animate-spin'></span>) : (<FileText className="w-5" />)
          }
